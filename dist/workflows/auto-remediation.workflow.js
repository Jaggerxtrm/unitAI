...
export async function executeAutoRemediation(params, onProgress) {
...
${plan}
`;
    return formatWorkflowOutput("Auto Remediation Plan", content, {
        maxActions,
        attachments
    });
}
export const autoRemediationWorkflow = {
...
//# sourceMappingURL=auto-remediation.workflow.js.map