...
export async function executeTriangulatedReview(params, onProgress) {
...
`;
    return formatWorkflowOutput("Triangulated Review", content, {
        files,
        goal,
...
export const triangulatedReviewWorkflow = {
...
//# sourceMappingURL=triangulated-review.workflow.js.map