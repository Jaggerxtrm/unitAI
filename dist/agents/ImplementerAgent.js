...
export class ImplementerAgent extends BaseAgent {
    ...
    description = "Precise code implementation with production-quality standards using Droid (GLM-4.6)";
    preferredBackend = BACKENDS.DROID;
...
...`;
     ...
     */
    getApproachInstructions(approach) {
        const instructions = {
...
- Keep changes localized and focused`
    ...
    extractCodeSnippets(text) {
        ...
        for (const codeBlock of codeBlocks) {
            ...
            const textBetween = text.substring(Math.max(0, codeBlock.index - 300), codeBlock.index);
...
//# sourceMappingURL=ImplementerAgent.js.map